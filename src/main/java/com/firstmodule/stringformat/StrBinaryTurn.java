package com.firstmodule.stringformat;

/**
 * @program: lkworkdevelop
 * @description: https://www.cnblogs.com/it-deepinmind/p/7429342.html
 * @author: likai
 * @create: 2019-06-05 09:03
 **/
public class StrBinaryTurn {
    ...
    public static void main(String[] args) {
        ...
        strBinaryTurn.StrToBool("hello world");
    }
